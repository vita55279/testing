...
async function startCooccurPage() {
	...
	document.getElementById('thresholdSlider').setAttribute('value', minRange);
...
function resetDiagram() {
	document.getElementById('thresholdSlider').value = minRange;
